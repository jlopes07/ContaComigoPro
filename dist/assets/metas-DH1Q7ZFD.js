import{a as c,s as r,f as e}from"./index-Bf9tqZDu.js";function u(){l(),c(()=>{var t;(t=document.getElementById("page-metas"))!=null&&t.classList.contains("active")&&l()})}function l(){const t=document.getElementById("goals-list");if(t){if(t.innerHTML="",r.goalsList.length===0){t.innerHTML='<div class="empty-state w-100" style="grid-column: 1/-1;"><i class="fa-solid fa-bullseye"></i><p>Nenhuma meta cadastrada.</p></div>';return}r.goalsList.forEach(a=>{const s=a.targetValue>0?Math.min(a.currentValue/a.targetValue*100,100).toFixed(0):0,i=a.currentValue>=a.targetValue,n=Math.max(a.targetValue-a.currentValue,0),o=e(n);t.innerHTML+=`
